...
void ore_copper_block_register(void)
{
  ...
  block_info.textures[DIRECTION_LEFT]   = "mod/assets/textures/ore_copper.png";
  block_info.textures[DIRECTION_RIGHT]  = "mod/assets/textures/ore_copper.png";
  block_info.textures[DIRECTION_BACK]   = "mod/assets/textures/ore_copper.png";
  block_info.textures[DIRECTION_FRONT]  = "mod/assets/textures/ore_copper.png";
  block_info.textures[DIRECTION_BOTTOM] = "mod/assets/textures/ore_copper.png";
  block_info.textures[DIRECTION_TOP]    = "mod/assets/textures/ore_copper.png";
...
{
  (void)entity;
  block_on_destroy_spawn_item(chunk, position, ore_copper_item_id_get());
}
