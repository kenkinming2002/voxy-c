...
void grass_block_register(void)
{
  ...
  block_info.textures[DIRECTION_LEFT]   = "bin/mod/assets/textures/grass_side.png";
  block_info.textures[DIRECTION_RIGHT]  = "bin/mod/assets/textures/grass_side.png";
  block_info.textures[DIRECTION_BACK]   = "bin/mod/assets/textures/grass_side.png";
  block_info.textures[DIRECTION_FRONT]  = "bin/mod/assets/textures/grass_side.png";
  block_info.textures[DIRECTION_BOTTOM] = "bin/mod/assets/textures/grass_bottom.png";
  block_info.textures[DIRECTION_TOP]    = "bin/mod/assets/textures/grass_top.png";
