...
static item_id_t ore_copper_item_id;
...
void ore_copper_item_register(void)
{
  ...
  item_info.mod = MOD;
  item_info.name = "ore_copper";
  item_info.texture =  "mod/assets/textures/ore_copper_item.png";
  item_info.on_use = ore_copper_item_on_use;

  ore_copper_item_id = register_item_info(item_info);
}

item_id_t ore_copper_item_id_get(void)
{
  return ore_copper_item_id;
}
