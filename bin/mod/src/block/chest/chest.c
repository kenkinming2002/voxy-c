...
void chest_block_register(void)
{
  ...
  block_info.textures[DIRECTION_LEFT]   = "bin/mod/assets/textures/chest_other.png";
  block_info.textures[DIRECTION_RIGHT]  = "bin/mod/assets/textures/chest_other.png";
  block_info.textures[DIRECTION_BACK]   = "bin/mod/assets/textures/chest_other.png";
  block_info.textures[DIRECTION_FRONT]  = "bin/mod/assets/textures/chest_front.png";
  block_info.textures[DIRECTION_BOTTOM] = "bin/mod/assets/textures/chest_other.png";
  block_info.textures[DIRECTION_TOP]    = "bin/mod/assets/textures/chest_other.png";
