...
void water_block_register(void)
{
  ...
  block_info.textures[DIRECTION_LEFT]   = "bin/mod/assets/textures/water.png";
  block_info.textures[DIRECTION_RIGHT]  = "bin/mod/assets/textures/water.png";
  block_info.textures[DIRECTION_BACK]   = "bin/mod/assets/textures/water.png";
  block_info.textures[DIRECTION_FRONT]  = "bin/mod/assets/textures/water.png";
  block_info.textures[DIRECTION_BOTTOM] = "bin/mod/assets/textures/water.png";
  block_info.textures[DIRECTION_TOP]    = "bin/mod/assets/textures/water.png";
